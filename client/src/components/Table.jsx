    ...
    return (
        ...
        <div className="bg-gray-700" style={{ "min-height": "100vh" }}>
            ...
            <p className="p-5 text-gray-400">
                Website still in the <b>development</b> phase. Only <b>Hydrogen</b> is available at the moment.
            </p>
            <div className="m-10 scale-90 sm:scale-100" role="region" tabindex="0">
                <ol id="periodic-table">
                <li onClick={handleElementClick} title="Hydrogen">H</li>
